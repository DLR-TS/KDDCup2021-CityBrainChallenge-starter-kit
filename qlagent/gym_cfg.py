...
MIN_CHECK_LENGTH = 26.0 # look upstream to find more queued vehicles if a lane is shorter than this optimized 10 40
JAM_THRESH = 0.91 # at which relative occupancy a lane is considered jammed, to be optimized 0.9 0.95
HEADWAY = 1.7 # to be optimized 1.2 2.2
...
JAM_BONUS = 9.0 # bonus vehicles to add to a jammed lane per act call (every 10s) until it gets green optimized 1 11#
...
LEFT_TURN_BONUS = 25 # optimized 0 50
