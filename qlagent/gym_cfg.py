...
MIN_CHECK_LENGTH = 18.0 # look upstream to find more queued vehicles if a lane is shorter than this optimized 10 40
...
JAM_BONUS = 8 # bonus vehicles to add to a jammed lane per act call (every 10s) until it gets green optimized 1 11#
MAX_GREEN_SEC = 156 # to be optimized 140 220#
...
STOP_LINE_HEADWAY = 9.6 # seconds to the stopline to be included in the queue optimized 8 12#
BUFFER_THRESH = 1 # number of vehicles in lane insertion buffer to consider lane jammed optimized 1 11#
FUTURE_JAM_LOOKAHEAD = 9 # number of edges optimized 0 10#
