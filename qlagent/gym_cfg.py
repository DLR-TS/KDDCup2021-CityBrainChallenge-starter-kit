...
JAM_THRESH  = 0.95  # at which relative occupancy a lane is considered jammed, to be optimized
SPEED_THRESH = 0.1  # at which relative speed a lane is considered jammed, to be optimized
...
STOP_LINE_HEADWAY = 10  # seconds to the stopline to be included in the queue
