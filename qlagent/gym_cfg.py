...
SPEED_THRESH = 0.025 # at which relative speed a lane is considered jammed, to be optimized 0 0.05#
JAM_BONUS = 0.2 # bonus vehicles to add to a jammed lane per act call (every 10s) until it gets green optimized 0 0.4
