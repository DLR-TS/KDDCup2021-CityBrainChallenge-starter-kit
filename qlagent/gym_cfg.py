...
MIN_CHECK_LENGTH = [45.0, 43, 45.0] #   look upstream to find more queued vehicles if a lane is shorter than this optimized 35 55
...
PREFER_DUAL_THRESHOLD = [3.0, 8, 8.0] #   How many vehicles could pass the intersection in 5s all red (if we have more vehicles in a dual queue switching, beats single queue discharge) optimized 1 11
STOP_LINE_HEADWAY = [9.6, 10.4, 10.4] #   seconds to the stopline to be included in the queue optimized 8 12
